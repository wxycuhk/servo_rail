...
#define HEXT_VALUE                       ((uint32_t)12000000) /*!< value of the high speed external crystal in hz */ //  MODIFY TO 12MHz if green
#endif
...
#define LEXT_VALUE                       ((uint32_t)0)   /*!< value of the low speed external clock in hz 32768 */
